  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      accept: {
        ...
        command:
          'env NODE_PATH=. ./node_modules/.bin/turbo --series=true --setUp=test/accept/server.js --tearDown=test/accept/server.js test/accept/test-sys.js test/accept/test-db.js'
      },
      coverage_unit: {
        options: {
          stdout: true,
      ...
      coverage_accept: {
        ...
        command: [
          ...
          'env NODE_PATH=. ./node_modules/.bin/istanbul cover --dir cov-accept ./node_modules/.bin/turbo -- --series=true --setUp=test/accept/server.js --tearDown=test/accept/server.js test/accept/test-sys.js test/accept/test-db.js',
          './node_modules/.bin/istanbul report',
