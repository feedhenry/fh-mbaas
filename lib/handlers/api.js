...
router.post('/apps/:domain/:environment/:appname/checkmigratedb', fhmbaasMiddleware.app.findOrCreateMbaasApp, middleware.checkMigrateDbMiddleware, function(req, res){
  return res.json(req.checkDbMigrateResult);
});

router.get('/apps/:domain/:environment/:appname/checkmigratedb', fhmbaasMiddleware.app.findMbaasApp, middleware.checkMigrateDbMiddleware, function(req, res){
  return res.json(req.checkDbMigrateResult);
});


router.post('/apps/:domain/:environment/:appname/migrateComplete', fhmbaasMiddleware.app.findMbaasApp, middleware.completeMigrateDbMiddleware, middleware.notifyAppDbMigration('stop'), function(req, res){
...
router.post('/apps/:domain/:environment/:appname/deploy', fhmbaasMiddleware.app.findOrCreateMbaasApp, fhmbaasMiddleware.app.updateMbaasApp, middleware.createDbMiddleware, function(req, res){
