 ...
 *
 * - downloadUrl: string - for storing the url provided by the download service
...
module.exports.ExportJob = mongoose.model('ExportJob', ExportJob);
module.exports.ExportJobSchema = ExportJobSchema;
