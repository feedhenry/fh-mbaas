...
function createDbForAppTypes(types) {
  return function middleware(req, res, next) {
    var deployMongoDb = req.body.deployMongoDb;
    logger.info("value of deployMongoDb is : ", req.appMbaasModel.type);
    var model = req.appMbaasModel;
    ...
    if(deployMongoDb){
         logger.info("it will create the database");
      ...
      logger.info("it will not create the database");
      return next();
    }
  };
}
