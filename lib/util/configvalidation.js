...
exports.configvalidation = function (config) {
  ...
  assert.equal(true, cfg.fhmbaas.mongo.hasOwnProperty("host"), util.format(exceptionMessages.MISSING_CONFIG_SECTION, 'host'));
  assert.equal(true, cfg.fhmbaas.mongo.hasOwnProperty("port"), util.format(exceptionMessages.MISSING_CONFIG_SECTION, 'port'));
  assert.equal(true, cfg.fhmbaas.mongo.hasOwnProperty("name"), util.format(exceptionMessages.MISSING_CONFIG_SECTION, 'name'));
};
