...
exports.configvalidation = function(config) {
  ...
  assert.equal(true, cfg.mongo.hasOwnProperty("form_user_auth"), util.format(exceptionMessages.MISSING_CONFIG_SECTION, 'mongo.form_user_auth'));
  assert.equal(true, cfg.mongo.form_user_auth.hasOwnProperty("user"), util.format(exceptionMessages.MISSING_CONFIG_SECTION, 'mongo.form_user_auth.user'));
  assert.equal(true, cfg.mongo.form_user_auth.hasOwnProperty("pass"), util.format(exceptionMessages.MISSING_CONFIG_SECTION, 'mongo.form_user_auth.pass'));
