...
module.exports = function(){
  ...
  router.get('/', paginate.middleware(fhConfig.value(PAGINATION_DEFAULT_LIMIT_KEY), fhConfig.value(PAGINATION_MAX_LIMIT_KEY)), handlers.list);
  ...
  router.post('/search', paginate.middleware(fhConfig.value(PAGINATION_DEFAULT_LIMIT_KEY), fhConfig.value(PAGINATION_MAX_LIMIT_KEY)), handlers.search);
  ...
  router.post('/filter', paginate.middleware(fhConfig.value(PAGINATION_DEFAULT_LIMIT_KEY), fhConfig.value(PAGINATION_MAX_LIMIT_KEY)), handlers.filter);
