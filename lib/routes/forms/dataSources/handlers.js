    ...
    async.waterfall([
      function getDeployedServ(cb){
        ...
        getDSDeployedService(req, deployedDataSource, function(err, deployedService){
          cb(err, deployedService);
        });
      },
      function updateDataSourceDataSet(deployedService, cb){
        updateSingleDataSource(req, deployedDataSource, deployedService, cb);
      }
    ], _.noop());
  });
}
...
function getDSDeployedService(req, dataSource, cb){
  ...
  getDeployedService({
    ...
    logger.debug("getDSDeployedService ", {
      deployedService: deployedService
    });
...
function validate(req, res, next){
  ...
  async.waterfall([
    function getDSDeployedServ(cb){
      getDSDeployedService(req, dataSource, cb);
    },
...
function refresh(req, res, next){
  async.waterfall([
    ...
    function updateDataSourceDataSet(dataSource, deployedService, cb){
      updateSingleDataSource(req, dataSource, deployedService, cb);
    },
